...
DATASET_PATH = ROOT_DIR / "datasets" / "long_text" / "long_text_samples.txt"
...
def main() -> None:
    ...
    print("Words | Morse Len | Simplified Len | Character Reduction | Compression Ratio")
    print("-" * 92)
    ...
    for text in samples:
        ...
        print(
            f"{word_count} | {morse_len} | {simplified_len} | "
